...
![|center|500x0](./WX20170712-073426@2x.png)
<center>图-1`32`位二进制数表示的无符号整数映射表</center>
### 3.整数（负整数、正整数和0）
...
![|center|0x400](./WX20170712-224315@2x.png)
<center>图-2 四位二进制数表示的无符号整数集合映射关系图</center>
...
![|center|0x400](./WX20170712-230107@2x.png)
<center>图-3 四位二进制数表示的整数集合映射关系方案1&2</center>

![@. | center | 0x400](./WX20170712-231114@2x.png)
<center>图-4 四位二进制数表示的整数集合映射关系方案3&4</center>
事实上映射方案远不止这些，如果我们让正整数的映射位置不和无符号整数的映射位置保持一致的话，我们还可以这样映射：将无符号整数的映射关系整体上移（-8）如图：
![|center|0x400](./WX20170713-065353@2x.png)
